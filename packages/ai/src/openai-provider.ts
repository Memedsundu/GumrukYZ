...
For declarations, wrapped GTİP values such as "8708,29," followed by "90,90,00" are one full code: 870829909000. Do not return only the partial first line. In Turkish "T.C. Gümrük Beyannamesi / Ekli Listesi" printouts, the same code may also appear as "87082990 90 00" on the summary page; normalize both layouts to the same full code.
...
For declaration totals, preserve "Toplam FOB", currency/value lines such as "EUR 54.556,03", and the "Toplam:" row separately when visible. Do not overwrite a labeled value with a nearby exchange-rate or TL conversion number.
